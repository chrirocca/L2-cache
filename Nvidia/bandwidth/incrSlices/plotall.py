...
df_A100 = pd.read_csv('slicesA100.log', sep='\s+', header=None)
df_V100 = pd.read_csv('slicesV100.log', sep='\s+', header=None)
...
plt.yticks(range(0, 2201, 200))  # Show from 0 to 2400 for y-axis, one tick every 400
