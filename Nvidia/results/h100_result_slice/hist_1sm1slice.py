...
for slice_num, z in z_dict.items():
    ...
    ax.set_xlim(left=30, right=50)

    # Set the x-ticks to be every 1 from 70 to 100
    plt.xticks(np.arange(30, 51, 10))

    # Add subticks every 1 for the x-axis from 0 to 80
    ax.set_xticks(np.arange(30, 51, 1), minor=True)
    ...
    plt.savefig(f"slice_{slice_num}_1.png", dpi=600, bbox_inches='tight')
    plt.show()
